    ...
    <>
      <div className="userRegister">
        ...
        <div className="d-flex flex-column">
          ...
          <Link className="btn-active" to="/Acknowledge">
            Acknowledge
          </Link>
  ...
  return (
    <div className="border contact-main py-4 px-4 rounded-3xl">
      <div className="d-flex justify-between align-items-center mb-3">
        <h2>Acknowledge the following to continue</h2>

        <p>Required fields</p>
      </div>
      <ul className="list-inline-item" style={{ listStyle: "disc" }}>
        <li>
          Info provided in support of this application, including but not
          limited to your resume or CV and the above information, is true and
          correct.
        </li>
        <li>
          False statements or material omissions of any kind during the hiring
          process may result in denial of employment or discharge.
        </li>
        <li>
          Nothing contained in this employment application or interview process
          is intended to create an employment contract between Amazon and you
          and that no representation or promise regarding the duration or the
          termination of employment with Amazon is authorized or binding unless
          contained in a written document signed by an officer of Amazon.
        </li>
      </ul>
      <Form className="d-flex align-items-center">
        <Form.Check
          type="checkbox"
          id="confirmCheckbox"
          label="By checking this box, I confirm I acknowledge the above."
          checked={checked}
          onChange={handleCheck}
          className="mr-2"
        />
      </Form>
      <Button variant="primary" className="mt-3" disabled={!checked}>
        Continue
      </Button>
    </div>
  );

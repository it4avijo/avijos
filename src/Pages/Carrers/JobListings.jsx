...
const JobListings = () => {
  return (
    <Container fluid>
      ...
      <Row>
        <Col md={3} className="fixed-sidebar bg-light mt-4">
        ...
        <Col md={9} className="content mt-5">
                ...
                <div className="d-flex justify-between align-items-baseline">
                  ...
                  <div className="posted">
                    <div className="d-flex align-items-center">
                      ...
                      <p className="mb-0 ms-2">{job.postedDate} </p>
                    </div>
                    <div className="d-flex align-items-center">
                      <strong>Updated:</strong>
                      <p className="mb-0 ms-2">{job.updatedDate}</p>
                    </div>
                  </div>
                </div>

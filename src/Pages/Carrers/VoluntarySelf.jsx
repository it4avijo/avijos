    ...
    <>
      <div className="userRegister">
        ...
        <div className="d-flex flex-column">
          ...
          <Link className="btn-active" to="/VoluntarySelf">
  ...
  return (
    <div className="border contact-main py-4 px-4 rounded-3xl">
      ...
      <p className="text-start">
        At Amazon, we actively hire ex-military (serving or former member of
        your country's Armed Forces), serving members of your country's Reserve
        Forces and military spouses in a wide variety of careers to allow them
        to apply their knowledge, skills, and leadership abilities to influence
        change, on behalf of our customers across the globe. Amazon operates a
        number of programs tailored to our military community.
      </p>
      <p className="text-start">
      ...
      <Form>
        <Form.Group as={Row}>
          <Form.Label as="legend" column sm={12}>
            Are you ex-military (transitioning or former member of your
            country's Armed Forces)?
          </Form.Label>
          <Col sm={12}>
            <Form.Check type="radio" label="Yes" name="gender" id="Yes" />
            <Form.Check type="radio" label="No" name="gender" id="No" />
            <Form.Check
              type="radio"
        ...
        <Form.Group as={Row}>
          <Form.Label as="legend" column sm={12}>
            Are you a member of the Reserve Forces of your country?
          </Form.Label>
          <Col sm={12}>
            <Form.Check type="radio" label="Yes" name="gender" id="Yes" />
            <Form.Check type="radio" label="No" name="gender" id="No" />
